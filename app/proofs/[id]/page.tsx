      ...
      <div className="mx-auto grid max-w-6xl gap-5">
        <header className="flex flex-wrap items-center justify-between gap-4 border-b border-ink/10 pb-4">
          <a className="inline-flex items-center gap-3 text-ink" href="/">
            ...
            <span>
              ...
              <span className="block text-sm text-ink/60">Recovered source proof</span>
            </span>
          </a>
        ...
        <section className="grid gap-5 rounded-lg border border-ink/10 bg-white p-5 shadow-sm lg:grid-cols-[minmax(0,1fr)_360px]">
          <div className="grid gap-5">
            <div>
              <p className="text-sm font-medium text-moss">Recovered source receipt</p>
              <h1 className="mt-1 text-3xl font-semibold tracking-normal">{receipt.title}</h1>
              <p className="mt-2 max-w-2xl text-sm leading-6 text-ink/70">
                This page records the source evidence a screenshot, repost, or edited copy can point back to.
                It does not certify that every claim in the content is true.
              </p>
            </div>
            ...
            <div className="rounded-md border border-amber/30 bg-amber/10 p-4">
              ...
              <p className="mt-2 text-sm leading-6 text-ink/70">
                Recovered source proof is not truth proof. Creator identity is self-declared unless a stronger
                trust level is shown. Missing C2PA or metadata should not be treated as proof that content is fake.
              </p>
            </div>
          </div>
